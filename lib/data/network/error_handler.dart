  ...
  Failure getFailure() {
    switch (this) {
      ...
      case DataSource.NO_INTERNET_CONECTTION:
        return Failure(ResponseCode.NO_INTERNET_CONECTTION,
            ResponseMessage.NO_INTERNET_CONECTTION.tr());
...
class ResponseMessage {
  ...
  static const String FORBIDDEN =
      AppStrings.forbiddenError; // success with no data (no content)
  static const String UNAUTHORIZED =
      AppStrings.unauthorizedError; // failure, user is not authorised
  static const String INTERNAL_SERVER_ERROR =
      AppStrings.internalServerError; // failure, crash in serverside
  static const String NOT_FOUND =
     AppStrings.notFoundError; // failure, crash in serverside
  ...
  static const String NO_INTERNET_CONECTTION =
